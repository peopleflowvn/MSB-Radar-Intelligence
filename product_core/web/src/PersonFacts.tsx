...
export default function PersonFactsSection({ personId }: { personId: number }) {
  ...
  return (
    <div className="talent-info-card" style={{ marginTop: 16 }}>
      <h3 style={{ margin: '0 0 4px', color: 'var(--text)' }}>Dữ liệu đã trích xuất &amp; nguồn gốc</h3>
