    ...
    const runAskStream = async () => {
      ...
      try {
        for await (const ev of api.assistantStream(
          ...
          if (ev.event === "route") { runAsk(); return; }
                              ...
                              >
                                ...
                                {ans.results.length === 0 ? (
                                  <div className="empty-results-box" style={{ width: "100%" }}>
                                    ...
                                    <h3>Không có ai khớp tiêu chí trên. Thử nới bớt một điều kiện.</h3>
                                  ...
                                  <>
                                    <div className="results-header-toolbar" style={{ margin: "0" }}>
                                      <div className="results-count-badge">
                                        <span>
                                          Tìm thấy <strong>{ans.results.length}</strong> khách hàng tiềm năng xếp hạng theo AI Match
                                        </span>
                                      </div>
