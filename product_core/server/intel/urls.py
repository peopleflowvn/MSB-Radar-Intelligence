...
urlpatterns = [
    ...
    path("review/bulk/", views.review_bulk_resolve, name="intel-review-bulk-resolve"),
    ...
    path("aliases/bulk/", views.alias_bulk_resolve, name="intel-alias-bulk-resolve"),
    path("aliases/<int:alias_id>/", views.alias_resolve, name="intel-alias-resolve"),
    path("aliases/<int:alias_id>/new-entry/", views.alias_new_entry,
         name="intel-alias-new-entry"),
    path("identity-conflicts/", views.identity_conflict_queue, name="intel-identity-conflicts"),
    path("identity-conflicts/<int:conflict_id>/resolve/", views.identity_conflict_resolve,
         name="intel-identity-conflict-resolve"),
